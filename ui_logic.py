...
EXCLUSION_MODULES = {
    ...
    "build_artifacts": {
        ...
        "folders": ["dist", "build", "out", "coverage", ".cache", ".sass-cache", "tmp", "temp", "release", "debug"],
        "extensions": [".pyc", ".pyo", ".class", ".o", ".obj", ".so", ".dll", ".exe", ".dylib", ".a", ".lib"],
    },
    "media_binary_assets": {
    ...
    "logs_cache": {
        ...
        "files": ["npm-debug.log", "yarn-error.log", ".eslintcache"],
        "extensions": [".log", ".pid", ".tmp", ".bak", ".swp", ".cache"],
    },
    "editor_vcs_noise": {
        "label": "Exclude editor/VCS noise",
        "folders": [".git", ".svn", ".hg", ".idea", ".vs", ".vscode"],
    ...
    "lockfiles": {
        ...
        "files": ["package-lock.json", "yarn.lock", "pnpm-lock.yaml", "composer.lock", "poetry.lock", "cargo.lock"],
        "extensions": [".lock"],
    },
    "test_reports": {
